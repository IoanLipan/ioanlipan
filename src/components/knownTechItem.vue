<template>
  <div>
    <div class='flex flex-col hover:bg-textcolor hover:bg-opacity-60 transition-all p-5 rounded-full' @click="openModal">
...
export default {
  ...
  props: {
    ...
    description: {
      type: String,
      default: 'Lorem ipsum igitus sqgwefvf sdcv r fverc vetgrwce',
    },
    level: {
      type: Number,
      default: 1,
