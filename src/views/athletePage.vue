  ...
  <div class="grid-of-12-container bg-slate-800">
    <div class="cols-2-10 font-mono text-white">
      ...
      <p class="text-lg px-8 py-6 tracking-wide rounded-2xl">
        ...
        The body reacts to what it is doing most of the time. Having a sedentary job
        and 10+ hours of screentime should not be a motivation to adopt a sedentary lifestyle.
      ...
      <div class="blog-container-grid-2-1">
        <div>
          <h1 class="blog-title">Basketball</h1>
      ...
      <div class="blog-container-grid-2-1">
        ...
        <div>
          <h1 class="blog-title">KickBoxing</h1>
      ...
      <div class="blog-container-grid-2-1 mb-10">
        ...
        <div>
          <h1 class="blog-title">Ping-Pong</h1>
